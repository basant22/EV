...
struct Theme {
    static let baseUrl:String  = "https://app.evplugincharge.com/SAW/api/app/"
    static let appName = "EV Plugin Charge"
    static let AVAILABLE = "Available"
    static let UNAVAILABLE = "UnAvailable"
    static let RazorPayKey = "rzp_test_qDJ3qeqlxgOl1j"
    static let GoogleApiKey = "AIzaSyCveP7t3U05tGO1ACsaIgD-VkzPQDT3Gzk"
    static let MAX_TEXT_LENGTH = 10
    static let Message = "Ok"
    //Api Connectors
    static let PunchLine =  "App to book charger and charge EV."
    ...
    static let HelpWebsite = "https://www.evplugincharge.com"
    static let HelpMobileNumber = "+917042113345"
    static let HelpMobileNumberNew = ""
    static let HelpEmail = ""
   ...
   // rgb(204,236,218)
    ...
    static let menuHeaderColor:UIColor = UIColor(red:20/255, green:90/255, blue:50/255, alpha:1.0)
    //UIColor(red:36/255, green:164/255, blue:75/255, alpha:1.0)
