...
import UIKit
//com.ThomasCookCorporate.app
//com.news.erranewsindia
struct Theme {
    static let baseUrl:String  = "https://app.vidyuthpower.com/vidyuthpower/api/app/"
    static let appName = "V-Power"
    ...
    //Api Connectors
    static let PunchLine =  " V-Power Mobile application provides EV users visibility and information of its chargers in their vicinity or desired routes. It is a secure access to charge their EV instantly or reserve a slot for charging later and pay for the services when available."
    ...
    static let RazorImage = "http://vidyuthpower.com/wp-content/uploads/2021/11/vidyuthpower-logo.png"
    //Payment vc Titles
    static let Name_Title = " Name: "
    static let Invoice_Id = " Invoice Id:"
    static let Rate_Title = " Rate: "
    ...
    static let HelpWebsite = "https://vidyuthpower.com"
    static let HelpMobileNumber = "+918123162452"
    static let HelpMobileNumberNew = "+916363606558"
    static let HelpEmail = "info@vidyuthpower.com "
   ...
   // rgb(204,236,218)
    ...
    static let RazorPayColor = "#32a852"
    static let gradientGreen:UIColor = UIColor(red:46/255, green:182/255, blue:44/255, alpha:1.0)
    static let newGreen:UIColor = UIColor(red:11/255, green:155/255, blue:74/255, alpha:1.0)
    static let emptyColor:UIColor = UIColor(red:213/255, green:245/255, blue:227/255, alpha:1.0)
    static let menuHeaderColor:UIColor = UIColor(red:16/255, green:104/255, blue:10/255, alpha:1.0)
